...
Vector2Data = _reflection.GeneratedProtocolMessageType('Vector2Data', (_message.Message,), {
...
AffineTransformData = _reflection.GeneratedProtocolMessageType('AffineTransformData', (_message.Message,), {
